...
import { deleteTicketCategory } from "requests/ticketCategory copy";

export function ticketCategoryHeader<Array>(reloadData: () => void) {
  return [
    ...
    },
    {
      ...
      renderCell: (params: GridRenderCellParams<Date>) => (
        <div style={{ flex: 1, display: "flex", padding: 3 }}>
          ...
          <DeleteAction
            actionDelete={deleteTicketCategory}
