...
import { IncidentCategory, incidentCategorySchema } from "./Interface";
import { SxProps } from "@mui/system";

export type FormProps = {
  sx?: SxProps;
  model: IncidentCategory | undefined;
  addAction: (data: IncidentCategory) => void;
  actionUpdate: (data: IncidentCategory) => void;
...
const Form: FC<FormProps> = ({
  ...
  const formAction = useFormik<IncidentCategory>({
    initialValues: {
      name: "",
      description: "",
    },
    validationSchema: incidentCategorySchema,
