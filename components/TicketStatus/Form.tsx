...
} from "../TicketsCategory/Interface";
import { SxProps } from "@mui/system";
import { TicketStatus, ticketStatusSchema } from "./InterfaceStatus";

export type FormProps = {
  sx?: SxProps;
  model: TicketStatus | undefined;
  addAction: (data: TicketCategory) => void;
  actionUpdate: (data: TicketCategory) => void;
...
const Form: FC<FormProps> = ({
  ...
  const formAction = useFormik<TicketStatus>({
    initialValues: {
      name: "",
      description: "",
    },
